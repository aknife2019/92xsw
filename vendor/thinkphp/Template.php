...
@include __ROOT__.'vendor/thinkphp/TagLib.php';
@include __ROOT__.'vendor/thinkphp/Cx.php';
@include __ROOT__.'vendor/thinkphp/File.php';
...
class Template
{
    ...
    public function parse(&$content)
    {
        ...
        // 替换固定的静态变量
        $content = str_replace(["{__PLUGIN__}","%7B__PLUGIN__%7D"],__PLUGIN__,$content);
        $content = str_replace(["{__TEM__}","%7B__TEM__%7D"],__TEM__,$content);
        $content = str_replace(["{__CSS__}","%7B__CSS__%7D"],__CSS__,$content);
        $content = str_replace(["{__JS__}","%7B__JS__%7D"],__JS__,$content);
        $content = str_replace(["{__IMG__}","%7B__IMG__%7D"],__IMG__,$content);
    ...
    private function parseTemplateFile($template)
    {
        ...
        if (is_file($template)) {
            ...
            echo 'template not exists:' . $template;exit;
        }
    }
